...
#import "ShawCountDownButton.h"

@interface ShawCountDownButton() {
...
@implementation ShawCountDownButton
    ...
    if (self.hlEnabled && (!self.haveBeenIn)) {
        ...
        switch (self.hlType) {
            case ShawCountDownButtonTypeNormal:
                ...
                break;
            case ShawCountDownButtonTypeOnlyLine:
                [self setTitleColor:self.highlightedColor forState:UIControlStateNormal];
                ...
                break;
            case ShawCountDownButtonTypeOnlyBackground:
